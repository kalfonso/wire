...
class KafkaWireSerializer<T: Message<T, *>>(
  ...
  fun serialize(topic: String?, record: T): ByteArray? {
    // TODO: retrieve from classpath
    val descriptor: Descriptor = getDescriptorForType(record)
  ...
  @Throws(
    ...
    return try {
      ...
      val indexes = schema.toMessageIndexes(record.getDescriptorForType().getFullName())
